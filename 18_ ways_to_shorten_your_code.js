...
// names.forEach(logArrayItems) итерация массива
...
// 17 поиск в массиве по параметру
...
console.log(Object.entries(car)) //показывает ключ + значение
console.log(Object.values(car)) //только значение
console.log(Object.keys(car)) //только ключ